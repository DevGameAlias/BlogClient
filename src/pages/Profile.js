...
const Profile = () => {
  ...
  return (
    <>
      ...
      <div className="flex justify-center flex flex-col items-center bg-gradient-to-r from-orange-100 via-orange-200 to-orange-100">
      <button
        className="  bg-blue-500 text-white p-2 rounded hover:animate-pulse "
        onClick={() => {
          setIsVisible(true);
        }}
      >
      ...
      {isVisible && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
          <div className="bg-white p-6 rounded-lg shadow-lg max-w-lg w-full relative z-50 ">
            <StoryCreation setIsVisible={setIsVisible} /> Add the StoryCreation
            component here
            {/* Insert Short story CRUD here */}
          </div>
        </div>
